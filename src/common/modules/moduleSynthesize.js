declare("GameModuleSynthesize", function() {
    ...
    function ModuleSynthesize() {
        ...
        this.autoSynthesize = function() {
        	...
        	settings.addStat(static.EnumStatSynthAutoGain, value);
        	settings.addStat(static.EnumStatSynthAuto);
        	this.addSynthesizeResult(value, static.EnumValueGainAuto);
        };
        ...
        this.manualSynthesize = function() {
        	...
        	settings.addStat(static.EnumStatSynthManualGain, value);
        	settings.addStat(static.EnumStatSynthManual);
        	this.addSynthesizeResult(value, static.EnumValueGainManual);
        ...
        this.addSynthesizeResult = function(value, valueGainType) {
        	...
        	if(valueGainType === undefined) {
        		valueGainType = static.EnumValueGainUndefined;
        	}
