define(function(require) {
    ...
    function isValueOfType(value, type) {
        ...
        switch(type) {
            ...
            case dataType.jsonArray: return Array.isArray(value);
    ...
    function getDefaultValueByType(type) {
        switch(type) {
            ...
            case dataType.jsonArray: return [];
    ...
    function getWriteValueByType(value, type) {
        ...
        switch(type) {
            ...
            case dataType.jsonArray: return JSON.stringify(value);
